...
export type HubSessionEvents = SessionEvents & {
  join: (connection: DataConnection) => void;
  leave: (connection: DataConnection) => void;
};

export class HubSession extends Session<HubSessionEvents> {
...
export type JoinedSessionEvents = SessionEvents;

export class JoinedSession extends Session<JoinedSessionEvents> {
  private readonly peer: Peer;
